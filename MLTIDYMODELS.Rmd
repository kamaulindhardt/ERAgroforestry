...
```{r Clean dataset for EDA and making colour range, code_folding=FALSE, eval=FALSE}
...
```{r Identifying outliers in outcome logRR, code_folding=FALSE, eval=FALSE}
...
```{r Generating costum colour object with 1050 colours, code_folding=TRUE, eval=FALSE}
...
```{r Creating histograms of our biophysical predictors, code_folding=TRUE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=15, fig.height=10, fig.cap = "Histogram of biophysical predictors vs. logRR"}
...
```{r Generating scatter plot between predictors and logRR, code_folding=TRUE, eval=FALSE}
...
```{r  layout="l-screen-inset shaded", code_folding=TRUE, fig.width=20, fig.height=15, fig.cap = "Scatter plot of biophysical predictors vs. logRR"}
expl.agfor.scatter <- readRDS(file = here::here("TidyMod_OUTPUT", "expl.agfor.scatter.RDS"))
...
```{r Generating QQ plot of biophysical predictors, code_folding=FALSE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=20, fig.height=15, fig.cap = "QQ plot of biophysical predictors"}
expl.agfor.qqplot.pred <- readRDS(file = here::here("TidyMod_OUTPUT", "expl.agfor.qqplot.pred.RDS"))

expl.agfor.qqplot.pred
```
...
```{r Generating QQ plot of outcomes RR and logRR, code_folding=FALSE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=20, fig.height=15, fig.cap =  "qq plot of outcomes RR and logRR"}
expl.agfor.qqplot.logRR <- readRDS(file = here::here("TidyMod_OUTPUT", "expl.agfor.qqplot.logRR.RDS"))

expl.agfor.qqplot.logRR
```
...
```{r Generate parallel coordinate plot of EQR discretized logRR vs biophysical predictors, code_folding=TRUE, eval=FALSE}
...
We will use the plot_boxplot() function from the DataExplorer package to create a multiples plot of boxplots for each continuous feature based on the outcome, logRR feature. Boxplots are powerful EDA visuals as they are very intuitivly showing where the most of the data is (inside of the box), and whether variables have $many$ outliers or not. Boxplots are also useful for a quick comparison of data distributions across groups, samples or categories, because they visualize center, spread and range
of every group. Thus, similarly to the correlation analysis we did above, boxplots also help to develop hypotheses.

Generating custom colour object with 180 colours

```{r Generating custom colour object with 180 colours, code_folding=TRUE, eval=FALSE}
...
```{r Generating boxplots of predictors and discretized logRR, code_folding=FALSE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=20, fig.height=15, fig.cap =  "Boxplots of predictors and discretized logRR"}
expl.agfor.boxplot.pred <- readRDS(file = here::here("TidyMod_OUTPUT", "expl.agfor.boxplot.pred.RDS"))

expl.agfor.boxplot.pred
```

The multiples plot above is showing each of the biophysical predictorsin separate plots as we have seen before. The novelty and slightly unusual aspects of the plot above, is that we have depicted our continuous outcome variable, logRR in a discretized manner on the y axis and shown the range of the respected biophysical predictor on the x-axis. The groupings, also called bins, of logRR for each of the biophysical predictors shows some promising trends: That we do see differences in thhe predictors for different levels of our discretized
logRR outcome. This is good news as these differences in the data can be used by our machine learning models. In addition, we also see that we have a large amount of outliers (Note: 1.5 \* IQR), especially in the central/median groups.
...
```{r Preparing correlation matrix of continous predictor variables, code_folding=FALSE, eval=FALSE}
...
```{r Viewing the correlation matrix of era agroforestry data, layout = "l-body-outset", results = 'asis'}
...
```{r Generating correlation plot of continous predictor variables, code_folding=FALSE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=10, fig.height=10, fig.cap = "Correlation matrix plot of all biophysical predictors"}
agroforest.corr.cont.pred.plot <- readRDS( here::here("TidyMod_OUTPUT","agroforest.corr.cont.pred.plot.RDS"))

agroforest.corr.cont.pred.plot
```
...
```{r Generating correlation matrix and correlation plot of logRR and continous predictor variables, code_folding=FALSE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=10, fig.height=10, fig.cap = "Correlation between biophysical predictors and logRR"}
agroforest.corr.cont.pred.logRR.plot <- readRDS( here::here("TidyMod_OUTPUT","agroforest.corr.cont.pred.logRR.plot.RDS"))

agroforest.corr.cont.pred.logRR.plot
```

```{r Generating corr plot data with logRR, code_folding=FALSE, eval=FALSE}
...
```{r Correlation between biophysical predictors and logRR, layout = "l-body-outset", results = 'asis'}
...
```{r Generating network correlation plot of continous predictor variables, code_folding=TRUE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=10, fig.height=10, fig.cap = "Network correlation plot between biophysical predictors and logRR"}
agroforest.network.corr.cont.pred.plot <- readRDS( here::here("TidyMod_OUTPUT","agroforest.network.corr.cont.pred.plot.RDS"))

agroforest.network.corr.cont.pred.plot
```
...
```{r Generating Cramers V data and plot, code_folding=TRUE, eval=FALSE}
...
```{r Cramers V correlation matrix of selected catagorical variables, layout = "l-body-outset", results = 'asis'}
...
```{r Generating combined scatter and density plot of sand content and logRR, code_folding=TRUE, eval=FALSE}
...
```{r Generating combined scatter and density plot of BIO.02 and logRR, code_folding=TRUE, eval=FALSE}
...
```{r Generating ridge plot for the BIO.1 temperature distribution across agroforestry practices, code_folding=TRUE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=15, fig.height=8, fig.cap = "Density ridge plot for BIO.01 Mean Annual Temperature distribution across all agroforestry practices"}
dens.ridge.points.qq.bio1 <- readRDS( here::here("TidyMod_OUTPUT","dens.ridge.points.qq.bio1.RDS"))

dens.ridge.points.qq.bio1
```
Soil Organic Carbon

```{r Generating ridge plot for the soil organic carbon distribution across agroforestry practices, code_folding=TRUE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=15, fig.height=8, fig.cap = "Density ridge plot forsoil organic carbon distribution across all agroforestry practices"}
dens.ridge.points.qq.soilC <- readRDS(here::here("TidyMod_OUTPUT","dens.ridge.points.qq.soilC.RDS"))

dens.ridge.points.qq.soilC
```
Sand content

```{r Generating ridge plot for the sand content distribution across agroforestry practices, code_folding=TRUE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=15, fig.height=8, fig.cap = "Density ridge plot for sand content distribution across all agroforestry practices"}
dens.ridge.points.qq.sand <- readRDS(here::here("TidyMod_OUTPUT","dens.ridge.points.qq.sand.RDS"))
...
```{r Generating ridge plot for the sand content distribution across the EQNo discritized logRR groups, code_folding=TRUE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=15, fig.height=8, fig.cap = "Density ridge plot for sand content distribution across the EQNo discritized logRR groupss"}
dens.ridge.EQNo.discritized.logRR.sand <- readRDS(here::here("TidyMod_OUTPUT","dens.ridge.EQNo.discritized.logRR.sand.RDS"))

dens.ridge.EQNo.discritized.logRR.sand
```
For the equal range discritization 

```{r Generating ridge plot for the sand content distribution across the EQR discritized logRR groups, code_folding=TRUE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=15, fig.height=8, fig.cap = "Density ridge plot for sand content distribution across the EQR discritized logRR groupss"}
dens.ridge.EQR.discritized.logRR.sand <- readRDS(here::here("TidyMod_OUTPUT","dens.ridge.EQR.discritized.logRR.sand.RDS"))
...
```{r Generating data and plot for visualising spatial relations of logRR data, code_folding=TRUE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=10, fig.height=8, fig.cap = "Spatial distribution of logRR values"}
logRR.plot <- readRDS( here::here("TidyMod_OUTPUT","logRR.plot.RDS"))
...
```{r Function for plotting spatial dependency of selected biophysical predictors, code_folding=FALSE, eval=TRUE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=10, fig.height=8, fig.cap = "Spatial distribution of selected biophysical predictors"}
...
```{r Performing Boruta analysis of predictor features - tree feature included, code_folding=TRUE, eval=FALSE}
...
```{r Performing Boruta analysis of predictor features - tree feature excluded, code_folding=TRUE, eval=FALSE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=15, fig.height=8, fig.cap = "Boruta plot of biophysical predictors with the tree feature included"}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=15, fig.height=8, fig.cap = "Boruta plot of biophysical predictors with the tree feature excluded"}
...
```{r Finalizing Boruta analysis, code_folding=TRUE, eval=FALSE}
# --------------------------------------------------------------------------------------------------------------------------------------------------------
# agrofor.boruta.with.tree
...
```{r List of attributes from the Boruta analysis where the Tree feature is included, code_folding=TRUE, eval=TRUE}
...
```{r List of attributes from the Boruta analysis where the Tree feature is excuded, code_folding=TRUE, eval=TRUE}
...
Ww see that the ten most important predictor features are: 
