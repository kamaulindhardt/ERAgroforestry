...
```{r}
dens.ridge.discritized.logRR.BIO1 <- 
  par.coord.data.EQNo %>%
  ...
  theme(legend.position = "none",
        panel.spacing = unit(0.2, "lines"),
        strip.text.x = element_text(size = 8)) +
  labs(title = "Sand content distribution across the seven clases of discritized logRR groups", 
       x = "Sand content",
...
```
```{r}
dens.ridge.discritized.logRR.sand <- 
  agrofor.biophys.modelling.data.discretized.logRR %>%
  ...
  theme(legend.position = "none",
        panel.spacing = unit(0.2, "lines"),
        strip.text.x = element_text(size = 8)) +
  labs(title = "Sand concentration distribution across the seven clases of discritized logRR groups", 
