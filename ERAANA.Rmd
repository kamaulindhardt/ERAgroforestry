...
```{r Getting data from from the machine learning workflowsets data, code_folding=TRUE, eval=TRUE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=10, fig.height=6, fig.cap = "Agroforestry practices vs sand content"}
ml.data.no.outliers.wf %>%
  rationalize() %>%
  step_impute_mean(all_numeric()) %>%
  relocate(logRR) %>%
...
```
```{r Creating agroforestry ridgeline data, code_folding=TRUE, eval=TRUE}
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=10, fig.height=6, fig.cap = "Ridge line plot: Distribution of sand content for the four different agroforestry practicest"}
agfor_ridgeline_data %>%
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=10, fig.height=6, fig.cap = "Ridge line plot: Distribution of precipitation of driest month for the four different agroforestry practices"}
agfor_ridgeline_data %>%
...
```{r layout="l-screen-inset shaded", code_folding=TRUE, fig.width=10, fig.height=6, fig.cap = "Ridge line plot : Distribution of temperature of warmest month for the four different agroforestry practices"}
agfor_ridgeline_data %>%
